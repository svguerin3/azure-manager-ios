...
#define TYPE_LIST_STORAGE_SERVICES          @"TYPE_LIST_STORAGE_SERVICES"
...
#define TYPE_SET_TABLE_SERVICE_PROPERTIES   @"TYPE_SET_TABLE_SERVICE_PROPERTIES"
#define TYPE_GET_QUEUE_PROPERTIES           @"TYPE_GET_QUEUE_PROPERTIES"
#define TYPE_SET_QUEUE_SERVICE_PROPERTIES   @"TYPE_SET_QUEUE_SERVICE_PROPERTIES"
